...
export default function SignupModal({ isOpen, onClose, onSuccess, bookingId }: SignupModalProps) {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-2">
            Create an account to access your tickets and manage your bookings
          </p>
          {bookingId && (
